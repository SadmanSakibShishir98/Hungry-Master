const createInfoDiv=(meal,mealInput)=>{
...
const showMealInfoDiv=(data,mealInput)=>{
    ...
    if(meal){
        meal.forEach(element=>{
            createInfoDiv(element,mealInput);
        });
    }
}
...
const searchMeal=()=>{
    ...
    if(mealInput){
        ...
        const noMealFound=document.getElementById('no-meal-found');
        noMealFound.innerText=`You havent entered anything`;
    }
}
...
const showMealDetailsDiv= data => {
    ...
    <div id="meal-details" class="card px-0 pb-1 border col-sm-12 col-md-6" style="border-radius:10px;">
    ...
    document.getElementById('meal-info-section').style.marginLeft="100px";
